...
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
coltest.py - Imports and exports column data to/from a spreadsheeet
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
"""
...
def saveMaster (sheet, ID):
    entries = m_DATASET[ID]    
...
def findMasterRow(val):
    indx = 1
    for j in m_DATASET['MASTER']:
        if val == j:
            return indx
        indx = indx + 1
    return 0

def saveColumn (sheet, column, ID):
    entries = m_DATASET[ID]    
...
if ( __name__ == "__main__"):
   ...
   fname = '../data/INFRASTRUCTURE.new.xlsx'
...
# test the import  
   coldata = LoadColsInSpreadsheet (fname, 'SURFACE.NEW' )
